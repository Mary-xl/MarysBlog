...
registered_images=2;<br>
image_stack=0;<br>
Set up number of images for a full bundle adjustment: num_of_images_per_bundle=NUM; <br>
while (true) <br>
     ...
     - If current view/camera successfully reconstructed (3.2): { <br>
                                                                ...
                                                                image_stack++; <br>
                                                                if num_of_images_per_bundle reached: {triangulate all new tracks (technique used in 2.3); <br>
